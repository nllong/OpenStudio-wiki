...
2. [Coding Standards](Coding-Standards#2-coding-standards)
    1. [General Guidelines](Coding-Standards#21-general-guidelines)
    2. [External References](Coding-Standards#22-external-references)
        1. [References](Coding-Standards#221-references)
        2. [Links](Coding-Standards#222-links)
    3. [Project Layout](Coding-Standards#23-project-layout)
        1. [Project Files](Coding-Standards#231-project-files)
        2. [Source Files](Coding-Standards#232-source-files)
        3. [External Dependencies](Coding-Standards#233-external-dependencies)
    4. [Naming](Coding-Standards#24-naming)
        1. [Namespaces](Coding-Standards#241-namespaces)
        2. [Other Naming Conventions](Coding-Standards#242-other-naming-conventions)
        3. [Naming Descriptiveness](Coding-Standards#243-naming-descriptiveness)
    5. [Files](Coding-Standards#25-files)
        1. [Include Statements](Coding-Standards#251-include-statements)
        2. [Using Statements and Namespace Aliases](Coding-Standards#252-using-statements-and-namespace-aliases)
    6. [Classes](Coding-Standards#26-classes)
        1. [Object Oriented Design](Coding-Standards#261-object-oriented-design)
        2. [Class Header Files](Coding-Standards#262-class-header-files)
        3. [Class Source Files](Coding-Standards#263-class-source-files)
        4. [Class Definitions](Coding-Standards#264-class-definitions)
        5. [Code Definitions in Header Files](Coding-Standards#265-code-definitions-in-header-files)
        6. [Inheritance and Virtual Functions](Coding-Standards#266-inheritance-and-virtual-functions)
        7. [Friends](Coding-Standards#267-friends)
        8. [Nested Classes](Coding-Standards#268-nested-classes)
    7. [Functions](Coding-Standards#27-functions)
        1. [Inline](Coding-Standards#271-inline)
        2. [Function Overloading](Coding-Standards#272-function-overloading)
        3. [Passing Arguments](Coding-Standards#273-passing-arguments)
        4. [Return Values](Coding-Standards#274-return-values)
        5. [Const-Correctness](Coding-Standards#275-const-correctness)
    8. [General](Coding-Standards#28-general)
        1. [Strings](Coding-Standards#281-strings)
        2. [Paths](Coding-Standards#282-paths)
        3. [Typedefs](Coding-Standards#283-typedefs)
        4. [Memory Management](Coding-Standards#284-memory-management)
        5. [Avoid Code Duplication](Coding-Standards#285-avoid-code-duplication)
        6. [Flow Control](Coding-Standards#286-flow-control)
        7. [Serialization](Coding-Standards#287-serialization)
        8. [SWIG Support](Coding-Standards#288-swig-support)
    9. [Code Portability](Coding-Standards#29-code-portability)
        1. [Compiler Warnings](Coding-Standards#291-comipler-warnings)
        2. [Exceptions](Coding-Standards#292-exceptions)
        3. [Logging](Coding-Standards#293-logging)
        4. [Unit Tests](Coding-Standards#294-unit-tests)
    10. [Formatting](Coding-Standards#210-formatting)
        1. [Indentation and Wrapping](Coding-Standards#2101-indentation-and-wrapping)
        2. [Comments](Coding-Standards#2102-comments)
        3. [Old Code and Commented-out Code](Coding-Standards#2103-old-code-and-commented-out-code)
        4. [Temporary Code](Coding-Standards#2104-temporary-code)
3. [Ruby Coding Standards](Coding-Standards#3-ruby-coding-standards)
    1. [Project Layout](Coding-Standards#31-project-layout)
    2. [Naming](Coding-Standards#32-naming)
    3. [Unit Tests](Coding-Standards#33-unit-tests)
    4. [Indentation and Wrapping](Coding-Standards#34-ndentation-and-wrapping)
    5. [Comments](Coding-Standards#35-comments)
...
#### 2.8.2. Paths
Use the typedef path in utilities/core/Path.hpp for all operations which access the filesystem. This will be boost::filesystem::wpath on Windows and boost::filesystem::path on POSIX. Use the file stream classes derived from boost::filesystem::fstream rather than std::fstream as they can take either version of path.
